...
#ifdef DEFAULTS_XYG
  #pragma message ( "using XYZ configuration" )
  // Grbl default settings for the xyg scanner.
  #define DEFAULT_X_STEPS_PER_MM 100.0 // MODIFIED
  #define DEFAULT_Y_STEPS_PER_MM 100.0 // MODIFIED
  #define DEFAULT_Z_STEPS_PER_MM 100.0 // MODIFIED
  #define DEFAULT_X_MAX_RATE 1500.0 // mm/min MODIFIED
  #define DEFAULT_Y_MAX_RATE 1500.0 // mm/min MODIFIED
  #define DEFAULT_Z_MAX_RATE 1500.0 // mm/min MODIFIED
  #define DEFAULT_X_ACCELERATION (50.0*60*60) // 10*60*60 mm/min^2 = 10 mm/sec^2 TODO
  #define DEFAULT_Y_ACCELERATION (50.0*60*60) // 10*60*60 mm/min^2 = 10 mm/sec^2 TODO
  #define DEFAULT_Z_ACCELERATION (50.0*60*60) // 10*60*60 mm/min^2 = 10 mm/sec^2 TODO
  #define DEFAULT_X_MAX_TRAVEL 300.0 // mm NOTE: Must be a positive value. TODO
  #define DEFAULT_Y_MAX_TRAVEL 300.0 // mm NOTE: Must be a positive value. TODO
  #define DEFAULT_Z_MAX_TRAVEL 20.0 // mm NOTE: Must be a positive value. TODO
  #define DEFAULT_SPINDLE_RPM_MAX 1000.0 // rpm
  #define DEFAULT_SPINDLE_RPM_MIN 0.0 // rpm
  #define DEFAULT_STEP_PULSE_MICROSECONDS 10
  #define DEFAULT_STEPPING_INVERT_MASK 0
